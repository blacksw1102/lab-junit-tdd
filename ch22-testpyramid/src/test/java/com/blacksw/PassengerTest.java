...
public class PassengerTest {
    ...
    public void testCreatePassengerWithInvalidSsn() {
        assertThrows(RuntimeException.class, () -> new Passenger("123-456-789", "John Smith", "US"));
        assertThrows(RuntimeException.class, () -> new Passenger("900-45-6789", "John Smith", "US"));
    }

    @Test
    public void testCreatePassengerWithInvalidUsIdentifier() {
        assertThrows(RuntimeException.class, () -> new Passenger("900-456-789", "John Smith", "GB"));
        assertThrows(RuntimeException.class, () -> new Passenger("123-45-6789", "John Smith", "GB"));
    }

    @Test
    public void testCreatePassengerWithInvalidCountryCode() {
        assertThrows(RuntimeException.class, () -> new Passenger("900-45-6789", "John Smith", "GJ"));
    }
    ...
    public void testPassengerToString() {
        ...
        assertEquals("com.blacksw.Passenger John Brown with identifier: 123-45-6789 from US", passenger.toString());
    }

package com.blacksw.ch17springbootbeans.registration;
...
public class PassengerRegistrationListener {
    ...
    public void confirmRegistration(PassengerRegistrationEvent passengerRegistrationEvent) {
        ...
        System.out.println("Confirming the registration for the passenger: " + passengerRegistrationEvent.getPassenger());
    }
}
